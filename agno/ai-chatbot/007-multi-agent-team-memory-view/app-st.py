...
restaurant_agent = Agent(
    ...
    instructions=dedent("""
        ...
        Use the restaurant_booking_tool to book a table at the restaurant
        It needs these Args:
        name (str): Name of the guest
        party_size (int): Number of people in the party
        date (str): Date of reservation (format: YYYY-MM-DD)
...
hotel_agent = Agent(
    ...
    instructions=dedent("""
        ...
        Use the hotel_booking_tool and it needs these args
...
airport_agent = Agent(
    ...
    instructions=dedent("""
        ...
        Pass the entities collected like the name etc. too to the tools.
        Use the airport_pickup_tool it needs these
        Args:
            name (str): Name of the guest
            flight_number (str): Flight number
            arrival_date (str): Date of arrival (format: YYYY-MM-DD)
...
team_of_agents = Agent(
    ...
    instructions=dedent("""
        ...
        Always pass the name of the user previously collected while passing tasks to other agents.
