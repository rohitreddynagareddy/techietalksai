...
# Add PDF and website upload section to sidebar
with st.sidebar:
...
@agent.tool
async def booking(ctx: RunContext[Deps]) -> str:
    ...
    return f"Your booking is confirmed! Booking Reference: {booking_ref}"
